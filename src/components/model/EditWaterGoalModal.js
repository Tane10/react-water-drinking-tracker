...
export default class EditWaterGoalModal extends React.Component {
    ...
    render() {
        ...
        <div>
            <Modal
                ...
                <Fade in={this.state.open} style={{ width: '261px', height: '282px' }} >
                    <Grid justify="center" container direction="column" style={{ justifyContent: 'center' }} >
                        ...
                        >
                            < Grid item xs={12} sm={12} >
                                <Typography 
                                // className={classes.modalTiltle}
                                 > Update Target Water </Typography>
                            </Grid>
                            <Grid item xs={12} sm={12} >
                                <Typography 
                                // className={classes.modalText}
                                 > Please enter your new water target below: </Typography>
                            </Grid>
                            <Grid item xs={12} sm={12} >
                                <TextField 
